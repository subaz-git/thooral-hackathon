...
1. Setup Project and CLI Framework:
   ...
   2. Implement `auth login`:
       * Prompt the user for Google Cloud Project setup and OAuth 2.0 credentials
         (client_secrets.json).
   ...
   6. Implement `docs get <document_id>`:
       ...
       * Extract and display the document's title and body content (initially raw, then refined to
         plain text).
